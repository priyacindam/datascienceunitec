...
public class AddGeofence {
  ...
  public void test1() throws Exception {
    ...
    Thread.sleep(2000);
   driver.findElement(By.id("map-input")).sendKeys(Keys.DOWN);
   driver.findElement(By.id("map-input")).sendKeys(Keys.ENTER);

 Thread.sleep(2000);
      //Select sel = new Select(driver.findElement(By.id("map-input")));
 //  sel.selectByVisibleText("Parnell Road, Remuera, Auckland, New Zealand");
  ...
  //     if (suggestions.getText().contains("Parnell Road, Remuera, Auckland, New Zealand")) {
       //     suggestions.click();
       ////     Thread.sleep(3000);
         //  break;
